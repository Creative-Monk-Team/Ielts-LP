    ...
    return (
        <div className={styles.container} id="whatLearn">
            <div className={styles.heading}>
                <h1>Unlock Your Potential in <span>2 Action-Packed Days!</span></h1>
                <h3>Join our <span>Crash Course</span> and Achieve Rapid Results</h3>
                <p className={styles.subtitle}>
                    This is your chance to master essential skills with step-by-step guidance and live practice sessions. 
                    Get ready to elevate your IELTS preparation!
                </p>
            </div>
            ...
            >
                ...
                <div className={styles.cardGrid}>
                    <div className={styles.card}>
                        ...
                        <div className={styles.cardContent}>Understand Speaking Assessment Criteria</div>
                    </div>
                    <div className={styles.card}>
                    ...
                    <div className={styles.card}>
                        ...
                        <div className={styles.cardContent}>Practice Live Speaking Sessions</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardNumber}>04</div>
                        <div className={styles.cardContent}>Expand Your IELTS Vocabulary</div>
                    </div>
                    <div className={styles.card}>
                    ...
                    <div className={styles.card}>
                        ...
                        <div className={styles.cardContent}>Exclusive Bonuses for Participants</div>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <div className={styles.cardGrid}>
                    <div className={styles.card}>
                        <div className={styles.cardNumber}>01</div>
                        <div className={styles.cardContent}>Discover IELTS Writing Format</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardNumber}>02</div>
                        <div className={styles.cardContent}>Learn Writing Assessment Criteria</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardNumber}>03</div>
                        <div className={styles.cardContent}>Generate Ideas for Any Essay Type</div>
                    </div>
                    <div className={styles.card}>
                        <div className={styles.cardNumber}>04</div>
            ...
            <Button text={"Reserve Your Spot Now"} /> 
                <p className={styles.ctaNote}>Hurry! Limited slots available for this exclusive 2-day crash course.</p>
            </div>
        </div>
    );
};
