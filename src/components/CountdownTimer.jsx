...
const CountdownTimer = () => {
  ...
  useEffect(() => {
    ...
    let birthday = new Date(`${yyyy}-12-28T18:00:00`);

    // If today's date is past 21st December, use the next year
    if (today > birthday) {
      birthday = new Date(`${nextYear}-12-29T18:00:00`);
    }
    ...
    <div className={styles.countdownTimer_container}>
      ...
      <div className={styles.timerHeader}>
        <p className={styles.dateDisplay}>
          📅 28th December, 2024 &nbsp;&nbsp; ⏱️ 4:00 - 6:00pm
        </p>
      </div>
      <div className={styles.timerHeader2}>
        <p className={styles.dateDisplay2}>
          📅 29th December, 2024 &nbsp;&nbsp; ⏱️ 10:30am - 12:30pm
        </p>
      </div>
      {countdownVisible && (
